        ...
        <div className={pageStyle.navbar}>
          <div className={pageStyle.container}>
            <div className={pageStyle.logo}>
              <a href="/">
                <div className={pageStyle.brandName}>
                  <img style={{ width: 105 }} src={Logo} alt="logo" />
                </div>
              </a>
            </div>
            ...
            {location.pathname === "/" ? (
              <form className={pageStyle.searchBar} onSubmit={handleSubmit}>
                ...
                />
                <button id="searchBtn" className={pageStyle.searchBtn}>
          ...
          <div className={pageStyle.categories}>
            {categoriesArray.map((obj, index) => (
              <span
                ...
                key={index}
                onClick={() => dispatch(onCategoryClick(obj))}
                id={`${obj}`}
              >
                {obj}
              </span>
